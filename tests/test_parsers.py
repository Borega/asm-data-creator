...
def test_parse_monolith_full_export_keeps_login_and_status_fields(tmp_path):
    csv_file = tmp_path / "monolith_full.csv"
    csv_file.write_text(
        "\n".join(
            [
                ...
                "Muster;;Maximilian;Max;01.01.2012;Männlich;;example;example;6a-2025/2026-Klasse-example;6a;6a Sp-2025/2026-Angebot-example;;max.login;max.muster@example.org;Aktiv;Lernende;DiViS;stu-1;exp-stu-1;01.08.2025;31.07.2032;28.01.2033",
                "Lehrer;;Lena;;01.01.1980;Weiblich;Lhr;example;example;;;6a Sp-2025/2026-Angebot-example;;lena.login;lena.lehrer@example.org;Aktiv;Lehrkraft;DiViS;tea-1;exp-tea-1;01.08.2025;31.07.2032;28.01.2033",
            ]
        ),
        encoding="utf-8",
    )
    ...
    assert result["students"][0]["anmeldekennung"] == "max.login"
    assert result["students"][0]["status"] == "Aktiv"
...
def test_parse_monolith_exposes_all_teacher_rows_even_without_current_year_offers(tmp_path):
    ...
    teacher_rows = result["teachers"]
    teacher_names = {(row["first_name"], row["last_name"]) for row in teacher_rows}
            ...
            [
                {
                    ...
                    "Vorname": "Tina",
                    "Klassennamen": "7b",
                    "Angebote": "##7b D-2024/2025-Angebot-example,7b E-2025/2026-Angebot-example",
                    "Rolle": "Lernende",
                    "Interne ID": "stu-2",
                    "Export ID": "exp-stu-2",
                },
            ...
            [
                {
                    ...
                    "Vorname": "Bar",
                    "Klassennamen": "8a",
                    "Angebote": "##FÖRDER Englisch 6-2025/2026-Angebot-example",
                    "Rolle": "Lernende",
                    "Interne ID": "s1",
                    "Export ID": "e1",
                }
